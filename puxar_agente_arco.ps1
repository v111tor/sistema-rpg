...
$AgentePath = Join-Path $ScriptDir "sistema\agentes\agente_criador_arcos_sistema_mecanico.md"
...
if ($Copiar) {
    ...
    Write-Output "Agente Criador de Arcos copiado para a area de transferencia."
    exit 0
}
